...
class BaseAgent(BaseModel):
  ...
  """The agent's ID in the database.""" 

  display_name: Optional[str] = None
  """The human-readable display name for the agent.
  
  This is used for display purposes in logs and UI, while the
  name attribute remains a valid Python identifier.
  """
