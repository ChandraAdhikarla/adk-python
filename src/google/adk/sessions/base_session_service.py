...
class BaseSessionService(abc.ABC):
  ...
  def update_session_parameters(
    ...
    """Updates the parameters of an existing session.

    Args:
      app_name: The name of the app.
      user_id: The id of the user.
      session_id: The id of the session to update.
      parameters: The new parameters to set or update.

    Returns:
      The updated session instance, or None if the session was not found.
    """
    pass
